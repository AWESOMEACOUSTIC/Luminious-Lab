...
const cardsData = [
    {
        ...
        title: 'Stay your best self, always thrive for more',
        description: '',
    ...
    return (
        <div className="w-full mx-auto md:mt-32 mt-15 flex flex-col gap-y-2 justify-center items-center">
            ...
            <div className="w-full overflow-x-auto">
                <div className="flex flex-row flex-nowrap gap-x-4 px-4 md:items-center md:justify-center">
            ...
            <button className='w-[37vw] sm:w-[20vw] h-[4.8vh] md:mt-10 flex gap-x-3 md:w-[22vw] lg:w-[18vw] items-center justify-center text-white font-[switzer-regular] md:py-8 rounded-full bg-black text-center cursor-pointer'>
                <span className='text-[0.78em] md:text-[1em] lg:text-[1.22em]'>
                    All products
                </span>
